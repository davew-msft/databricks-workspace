...
# MAGIC %md
# MAGIC This will be very similar to Yellow cab data.
...
destTranDir = "%stransactions/green-taxi/" %  destProjDir #Root dir for consumable data
print (destTranDir)
...
for j in range(2016,2018):
    ...
    for i in range(startMonth,endMonth+1): 
      ...
      #Destination path  
      #destDataDir = "{}/trip_year={}/trip_month={:02d}/".format(destTranDir,j,i)
...
# MAGIC USING DELTA
# MAGIC LOCATION '/mnt/lake/raw/nyctaxi/transactions/green-taxi/';
...
# MAGIC %sql
# MAGIC select * from taxi_db.green_taxi_trips_raw LIMIT 100;
