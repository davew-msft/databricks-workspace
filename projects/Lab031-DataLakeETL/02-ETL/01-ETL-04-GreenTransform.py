...
# MAGIC %md
# MAGIC # Transform the Green taxi data
...
destDataDirRoot = "/mnt/lake/curated/nyctaxi/transactions/green-taxi" 
...
# MAGIC USING DELTA
# MAGIC LOCATION '/mnt/lake/curated/nyctaxi/transactions/green-taxi';
