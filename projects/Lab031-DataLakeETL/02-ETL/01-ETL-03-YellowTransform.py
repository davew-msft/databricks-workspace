...
# MAGIC %md
# MAGIC # Transform the Yellow taxi data
...
destDataDirRoot = "/mnt/lake/curated/nyctaxi/transactions/yellow-taxi" 
...
# MAGIC USING DELTA
# MAGIC LOCATION '/mnt/lake/curated/nyctaxi/transactions/yellow-taxi';
